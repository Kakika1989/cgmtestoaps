...
function init (ctx) {
  ...
  const timeago = require('./timeago')(ctx); // TODO there should be a better way to handle dependencies than this
  const openaps = require('./openaps')(ctx); // TODO there should be a better way to handle dependencies than this
